...
// {Elza=SDET, Mehmet=Developer, Stefan=Developer, Rishat=PO, Ismail=SM, Tamara=SDET, Adnan=QA}]
        ...
        System.out.println("Here are the Scrum Masters :");
        List<Map<String,String>> scrumTeams=new ArrayList<>(Arrays.asList(array));
        ...
        System.out.println("Here are the Developers :");
