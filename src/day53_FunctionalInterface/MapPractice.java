...
public class MapPractice {
    public static void main(String[] args) {
        ...
        List<Map<String, Double>> allUnits = new ArrayList<>(Arrays.asList(unit1, unit2, unit3, unit4, unit5, unit6));
        ...
        for (Map<String, Double> eachUnit : allUnits) {
            for (Map.Entry<String, Double> eachPair : eachUnit.entrySet()) {
                number++;
                System.out.println(number + ". " + eachPair.getKey() + " : " + eachPair.getValue() + " hours");
            }
        }
        System.out.println("----------------the java topics that we spend more than 7 hours-----------------------");
        ...
        System.out.println("--------------the java topics that we spend less than 3 hours--------------------");
        ...
        System.out.println("------------Which Java Topic has the maximum hours?----------------------------");
        ...
        for (Map<String, Double> eachUnit : allUnits) {
            for (Map.Entry<String, Double> eachPair : eachUnit.entrySet()) {
                ...
                if (eachPair.getValue() > maxHours) {
                    maxHours = eachPair.getValue();
                    name1 = eachPair.getKey();
                }
                if (eachPair.getValue() < minHours) {
                    minHours = eachPair.getValue();
        ...
        System.out.println("name1 = " + name1+" -> "+maxHours);
        System.out.println("name2 = " + name2+" ->"+minHours);
    }
}
