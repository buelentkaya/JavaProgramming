...
import day36_InheritenceOOP.animalTask.Animal;
import day39_EncapsulationAndInheritancePractice.ShapeTask.Circle;
import day39_EncapsulationAndInheritancePractice.ShapeTask.Rectangle;
import day39_EncapsulationAndInheritancePractice.ShapeTask.Shape;
import day39_EncapsulationAndInheritancePractice.ShapeTask.Square;
import day43_OOP_Abstraction.employeeTask.*;
import day44_OOP_Abstraction.animalTask.Cat;
import day44_OOP_Abstraction.animalTask.Dog;
import day44_OOP_Abstraction.animalTask.Playable;
import day45_Abstraction_Interface.shape.Triangle;
...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
       ...
       // employee.bugReport();
        ...
        Animal animal = new Animal("Max", "Husky", 'M', 3, "Small", "White");
        animal.drink();
        animal.eat();
       // animal.play();
      //  animal.bark();
      ...
      //  animal2.eat();
        ...
        Cat animal3 = new Cat("Max", "Husky", 'M', 3, "Small", "White");
